...
^bb3:
  ...
  pdl_interp.record_match @rewriters::@if_true_rewriter(%arg0 , %5 : !pdl.operation, !pdl.type) : benefit(1) -> ^bb6
^bb4:
  pdl_interp.check_operation_name of %arg0 is "scf.execute_region" -> ^bb6, ^bb7
^bb6:
  pdl_interp.record_match @rewriters::@execute_region_rewriter(%arg0 : !pdl.operation) : benefit(1) -> ^bb7
^bb7:
  pdl_interp.finalize
}
