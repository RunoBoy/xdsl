...
// CHECK: func.func @main(%arg0: tensor<4x4xf32>, %arg1: tensor<4x4xf32>) -> tensor<4x4xf32> {
...
// CHECK-NEXT:       %init_alloc = scf.for %arg1_1 = %c0 to %c4 step %c1 iter_args(%t_alloc = %alloc) -> (tensor<4x4xf32>) {
...
// CHECK-NEXT:       }
// CHECK-NEXT:       %final_alloc, %final_alloc_1 = scf.for %arg1_2 = %c0 to %c4 step %c1 iter_args(%outer_alloc = %init_alloc, %outer_alloc_1 = %arg0) -> (tensor<4x4xf32>, tensor<4x4xf32>) {
...
// CHECK-NEXT:       %final_alloc_2 = equivalence.class %24, %23, %final_alloc : tensor<4x4xf32>
...
// CHECK-NEXT:       %27 = func.call @dot(%final_alloc_2, %arg1) : (tensor<4x4xf32>, tensor<4x4xf32>) -> tensor<4x4xf32>
